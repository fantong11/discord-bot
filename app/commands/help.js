...
class Help extends Command {
    constructor() {
        super("help", "List all commands or get info about a specific one.");
    ...
    execute() {
        ...
        if (!this.args.length) return this.message.channel.send({ embeds: [this._buildListEmbed(commands, prefix)] });
        ...
        this.message.channel.send({ embeds: [this._buildDetailEmbed(new CommandClass(), prefix)] });
    }
    ...
    executeSlash(interaction) {
        ...
        interaction.reply({ embeds: [this._buildDetailEmbed(new CommandClass(), "/")] });
    }
}
